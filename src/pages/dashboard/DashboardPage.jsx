    ...
    <div className="flex flex-col">
      <div className="grid grid-cols-2 md:grid-cols-2 whitespace-nowrap h-[100px] rounded-xl">
        <div className="relative flex flex-col justify-center items-center p-3 bg-[#F2F2F2] gap-1">
          <p className="text-[#9333EA] text-2xl font-bold mr-10">200K</p>
          <p className="text-xl font-semibold">Total User</p>
          <div className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 w-1 h-12 bg-[#9333EA]" />
        </div>
        <div className="flex flex-col justify-center items-center p-3 bg-[#F2F2F2] gap-1">
          <p className="text-[#9333EA] text-2xl font-bold mr-10">$120K</p>
      ...
      <div className="w-full p-5 bg-[#F2F2F2] rounded-lg shadow-md mt-5">
        <div className="flex flex-col md:flex-row md:justify-between lg:justify-between items-center gap-5 my-5">
          <div>
            <h1 className="text-xl text-[#9333EA] font-semibold">User Growth</h1>
          </div>
          <div className="flex justify-between items-center gap-5 whitespace-nowrap">
            <div className="relative w-full md:w-32">
              ...
              <button
                ...
                className="w-full px-3 py-2 border border-[#9333EA] rounded-md flex justify-between items-center bg-white transition"
              >
                <span className="text-[#9333EA]">{selectedYear}</span>
                <FaChevronDown className="text-[#9333EA] w-5 h-5 ml-5" />
              </button>
                ...
                <div className="absolute z-10 w-full bg-white border border-gray-300 rounded-md mt-1 max-h-60 overflow-y-auto shadow-lg text-lg">
                  {years.map((year) => (
                    <div
                      ...
                      className={`p-2 cursor-pointer hover:bg-gray-100 transition ${year === selectedYear ? "bg-[#9333EA] text-white" : ""
                        }`}
                    >
                      {year}
                    </div>
      ...
      <div className="mt-5">
        <h1 className="text-2xl text-[#9333EA] font-bold mb-5">Recent Joined User</h1>
        <RecentUsers />
      </div>
    </div>
  );
