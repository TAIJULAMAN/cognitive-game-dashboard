    ...
    <div className="bg-white w-full max-w-xl mx-auto px-4 sm:px-6 md:px-8 pt-8 py-5 rounded-md border border-gray-200 shadow-sm">
      ...
      <form className="space-y-4">
        <div className="w-full">
          <label
            htmlFor="password"
            className="text-sm md:text-base text-[#9333EA] mb-2 font-semibold"
          >
            Current Password
          </label>
        ...
        <div className="text-center pt-2">
          <button className="bg-[#9333EA] text-white font-semibold w-full py-3 rounded-md hover:opacity-95 transition">
            Save & Change
          </button>
        </div>
      </form>
